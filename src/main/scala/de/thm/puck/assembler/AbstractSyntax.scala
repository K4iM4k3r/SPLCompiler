...
object AbstractSyntax {
  ...
  case class Ldhw(srcR: Int, addressR: Int) extends Instruction
  case class Ldw(srcR: Int, addressR: Int) extends Instruction
  case class Stb(dstR: Int, addressR: Int) extends Instruction
  case class Sthw(dstR: Int, addressR: Int) extends Instruction
  case class Stw(dstR: Int, addressR: Int) extends Instruction
  ...
  case class Setw(dstR: Int, value: Either[Long, Tokens.Identifier]) extends Instruction
