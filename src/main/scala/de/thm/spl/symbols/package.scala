...
package object symbols {
  ...
  case class ParameterSymbol(override val name: String, typ: Type, isRef: Boolean) extends Symbol
  case class VariableSymbol(override val name: String, typ: Type) extends Symbol
